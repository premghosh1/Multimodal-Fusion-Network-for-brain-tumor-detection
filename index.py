...
def segment_image():
    ...
    img = cv2.imread("../Multimodal-Image-Fusion-Desktop-App-master/static/fusion.jpg")
    ...
    cv2.imwrite("../Multimodal-Image-Fusion-Desktop-App-master/static/segmented.jpg", im1)
...
def fuse_image():
    ...
    #Performing fusion
    input_images=[]
    mri = cv2.imread('../Multimodal-Image-Fusion-Desktop-App-master/static/mri_0.jpg')
    mri = cv2.cvtColor(mri, cv2.COLOR_BGR2GRAY)

    ct = cv2.imread('../Multimodal-Image-Fusion-Desktop-App-master/static/ct_0.jpg')
    ct = cv2.cvtColor(ct, cv2.COLOR_BGR2GRAY)
    input_images.append(mri)
    input_images.append(ct)
    FU = Fusion(input_images)
    fusion_1 = FU.fuse()
    cv2.imwrite('../Multimodal-Image-Fusion-Desktop-App-master/static/fusion_1.jpg', fusion_1)

    input_images=[]
    mri = cv2.imread('../Multimodal-Image-Fusion-Desktop-App-master/static/mri_1.jpg')
    mri = cv2.cvtColor(mri, cv2.COLOR_BGR2GRAY)

    ct = cv2.imread('../Multimodal-Image-Fusion-Desktop-App-master/static/ct_1.jpg')
    ct = cv2.cvtColor(ct, cv2.COLOR_BGR2GRAY)
    input_images.append(mri)
    input_images.append(ct)
    FU = Fusion(input_images)
    fusion_2 = FU.fuse()
    cv2.imwrite('../Multimodal-Image-Fusion-Desktop-App-master/static/fusion_2.jpg', fusion_2)

    input_images=[]
    mri = cv2.imread('../Multimodal-Image-Fusion-Desktop-App-master/static/mri_2.jpg')
    mri = cv2.cvtColor(mri, cv2.COLOR_BGR2GRAY)

    ct = cv2.imread('../Multimodal-Image-Fusion-Desktop-App-master/static/ct_2.jpg')
    ct = cv2.cvtColor(ct, cv2.COLOR_BGR2GRAY)
    input_images.append(mri)
    input_images.append(ct)
    FU = Fusion(input_images)
    fusion_3 = FU.fuse()
    cv2.imwrite('../Multimodal-Image-Fusion-Desktop-App-master/static/fusion_3.jpg', fusion_3)

    input_images=[]
    mri = cv2.imread('../Multimodal-Image-Fusion-Desktop-App-master/static/mri_3.jpg')
    mri = cv2.cvtColor(mri, cv2.COLOR_BGR2GRAY)

    ct = cv2.imread('../Multimodal-Image-Fusion-Desktop-App-master/static/ct_3.jpg')
    ct = cv2.cvtColor(ct, cv2.COLOR_BGR2GRAY)
    input_images.append(mri)
    input_images.append(ct)
    FU = Fusion(input_images)
    fusion_4 = FU.fuse()
    cv2.imwrite('../Multimodal-Image-Fusion-Desktop-App-master/static/fusion_4.jpg', fusion_4)

    coeffs=(fusion_1,(fusion_2,fusion_3,fusion_4))
    fusion=pywt.idwt2(coeffs,'haar')

    cv2.imwrite('../Multimodal-Image-Fusion-Desktop-App-master/static/fusion.jpg', fusion)
